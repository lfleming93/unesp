...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { employee_id: @treatment.employee_id, installation_id: @treatment.installation_id }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { employee_id: @treatment.employee_id, installation_id: @treatment.installation_id }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
